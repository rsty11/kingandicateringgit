...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="compose.php"><i class="fa fa-envelope"></i> <span>Email</span></a>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mailbox
        <small>You can send email to clients from here.</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-primary">
              ...
              <div class="form-group">
                    ...
                    <?php echo "" .date("F d, Y") . "<br><br>";?> <br>  
                      ...
                      <br><br>
                        ...
                        Feel free to contact us at any of the following contact numbers:<br>
                        <ul>
                            <ol>(042) 5404297</ol>
                            <ol>09255124167</ol>
                            <ol>09175847379</ol>
            ...
            <div class="box-footer">
              <div class="pull-right">
                ...
                <a href="../../dash.php"><button type="button" class="btn btn-default"><i class="fa fa-times"></i> Discard</button></a>
                  </div></form>
            <!-- /.box-footer -->
