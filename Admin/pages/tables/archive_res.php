  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Archived Reservations</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header" style="aligh: right;">
                ...
                <a href="#" type="button" data-href="resHardDel.php" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-danger"><span class="glyphicon glyphicon-inbox"></span> Delete All</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div style="overflow-x:auto;">
                <?php $result = mysqli_query($mysqli,"SELECT * FROM archived_res"); ?>
              <table id="example1" class="table table-bordered table-responsive table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" type="button" data-href="customerResDelete.php?delete=<?php echo $row['res_ID']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                    ...
                    <a href="../examples/invoice-print.php?print=<?php echo $row['res_ID']; ?>" type="button" class="btn btn-success btn-xs" target="_blank"><span class="glyphicon glyphicon-print"></span> Print</a>
                        <a href="../mailbox/compose.php?send=<?php echo $row['res_ID']; ?>" type="button" class="btn btn-warning btn-xs" target="_blank"><span class="glyphicon glyphicon-send"></span> Email</a>
                  </div>
                    </td>
                    </tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Think twice before you click. Deleting all archived reservations cannot be undone!</p>
              </div>
